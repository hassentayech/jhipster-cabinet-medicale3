package com.forticas.cabinet3.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.forticas.cabinet3.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.forticas.cabinet3.repository.UserRepository.USERS_BY_EMAIL_CACHE);
