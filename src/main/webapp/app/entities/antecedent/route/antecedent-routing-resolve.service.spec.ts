...
describe('Service Tests', () => {
  describe('Antecedent routing resolve service', () => {
    ...
    let resultAntecedent: IAntecedent | undefined;
    ...
    describe('resolve', () => {
      ...
      it('should return new IAntecedent if id is not provided', () => {
        // GIVEN
        ...
        expect(resultAntecedent).toEqual(new Antecedent());
      });

      it('should route to 404 page if data not found in server', () => {
        // GIVEN
        jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Antecedent })));
        mockActivatedRouteSnapshot.params = { id: 123 };
